...
import "./gezegenlerEvlerde.css"
import 'bootstrap/dist/css/bootstrap.css';
import 'bootstrap/dist/js/bootstrap.js';


function GezegenlerEvlerde(props) {
  ...
  return (
    ...
    <div className='gezegenlerEvlerdeTitles'>Gezegenler Evlerde</div>
    ...
    <div class="card">
        ...
        <div class="card-body">
          <h5 classname="gezegenlerCardTitle">Gezegenler Evlerde Ne Demek?</h5>
...
export default GezegenlerEvlerde;
